...
namespace KalkulatorPrzekroju
{
    internal class CircleSection
    {
        ...
        /// </summary>
        public CircleSection reversedSection { get { return new CircleSection(currentConrete, currentSteel, b, h, fi2, spacing2, c2, As2, fi1, spacing1, c1, As1); } }

        private CircleSection(Concrete concrete, Steel steel, double b, double h, double fi1, double spacing1, double c1, double As1, double fi2, double spacing2, double c2, double As2)
        {
            this.b = b;
            this.h = h;
            this.fi1 = fi1;
